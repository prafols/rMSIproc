...
AlignSpectrumToReference <- function(ref, x) {
    .Call('rMSIproc_AlignSpectrumToReference', PACKAGE = 'rMSIproc', ref, x)
}

FullImageAlign <- function(basePath, fileNames, refSpectrum, numRows, dataType, numOfThreads, AlignmentIterations = 3L, AlignmentMaxShiftPpm = 200L) {
    .Call('rMSIproc_FullImageAlign', PACKAGE = 'rMSIproc', basePath, fileNames, refSpectrum, numRows, dataType, numOfThreads, AlignmentIterations, AlignmentMaxShiftPpm)
}

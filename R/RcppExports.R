...
IsotopeAnnotator <- function(massPeaks, massChannels, numPixels, NumIso, PeakMtx, massVec, massChanVec, scansT, accu) {
    .Call('_rMSIproc_IsotopeAnnotator', PACKAGE = 'rMSIproc', massPeaks, massChannels, numPixels, NumIso, PeakMtx, massVec, massChanVec, scansT, accu)
}

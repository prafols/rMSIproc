...
adductAnnotation <- function(numMonoiso, numAdducts, tolerance, R_monoisitopeMassVector, R_adductMassVector) {
    .Call('_rMSIproc_adductAnnotation', PACKAGE = 'rMSIproc', numMonoiso, numAdducts, tolerance, R_monoisitopeMassVector, R_adductMassVector)
}

isotopeAnnotator <- function(massPeaks, massChannels, numPixels, numIso, PeakMtx, massVec, massChanVec, tolerance, scoreThreshold, ToleranceInScans) {
    .Call('_rMSIproc_isotopeAnnotator', PACKAGE = 'rMSIproc', massPeaks, massChannels, numPixels, numIso, PeakMtx, massVec, massChanVec, tolerance, scoreThreshold, ToleranceInScans)
}

...
PeakSelectorC <- function(massChannels, numPixels, NumIso, PeakMtx, massVec, ppmT) {
    .Call('_rMSIproc_PeakSelectorC', PACKAGE = 'rMSIproc', massChannels, numPixels, NumIso, PeakMtx, massVec, ppmT)
}

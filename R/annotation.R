...
#' rMSIannotation
#' 
#' Peak annotation tool. First, searches for isotopic ions in the peak matrix and evaluates them using morphology, intensity and mass error criteria.
...
#' @param addu.adducts Data frame containing the adducts to be searched. By defalut (+H, +Na and +K). It must have three columns.\itemize{
